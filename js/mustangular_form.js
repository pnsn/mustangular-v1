...
formApp.service('FinalizeParams', ['$httpParamSerializer', '$filter', '$window', function($httpParamSerializer, $filter, $window){
  ...
  this.submit = function(params) {
    ...
    //Redirect
    $window.location.href = "/mustangular/mustangular_map.html?" + $httpParamSerializer(master);
  } 
